...
### How does it work?
It hooks to `WifiNative#setStaMacAddress` method that's usually used to replace current active MAC Address with a new one, mainly to randomize a MAC Address when connecting to new wifi.
...
3. Hook `WifiNative#setStaMacAddress` and do the transformation there
